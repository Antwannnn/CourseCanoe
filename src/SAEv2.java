...
public class SAEv2 {
    ...
    public static void main(String[] args){
        ...
        int nbCandidats, nbDisqualifiés, nbPortes, z;
        ...
        for(int i = 0; i < delegate; i++){
            ...
            if(!disqualifié){
                saisirTabTemps(tabTempsManche1, nbCandidats, "Veuillez saisir le temps pour le " + (i+1) + "ème participant pour la manche 1: ", (i));
                ...
                saisirTabTemps(tabTempsManche2, nbCandidats, "Veuillez saisir le temps pour le " + (i+1) + "ème participant pour la manche 2: ", (i));
                ...
                tabClassementFinal[z] = moyenneTempsCompenses;
        ...
        for (int xyz = 0; xyz < nbCandidats; xyz++) {
            System.out.println(tabClassementFinal[xyz]);
            System.out.println(numeroDeBrassard[xyz]);
        }
    ...
    public static void podium(int pfNbCompetiteur, double [] pfScore, int [] pfBrassard) {
        ...
        System.out.println("Nombre de candidats : " + pfNbCompetiteur);
        for (i = 0; i < pfNbCompetiteur; i++) {
            System.out.println(i+1 + " Score : " + pfScore[i]);
            System.out.println(i+1 + " Brassard : " + pfBrassard[i]);
        }
        // traitement
        ...
        // si il y a plusieurs premiers
            ...
            for (i = 0; i < nbPremier; i++) {
                System.out.print(pfBrassard[indicePremier[i]]);
            }
            System.out.println(afficherTempsConverti(premier, 1));
        }
        ...
        // si il y a plusieurs deuxième
            ...
            for (i = 0; i < nbDeuxieme; i++) {
                System.out.print(pfBrassard[indiceDeuxieme[i]]);
            }
            System.out.println(afficherTempsConverti(deuxieme, 2));
        }
        ...
        // si il y a plusieurs troisième
            ...
            for (i = 0; i < nbTroisieme; i++) {
                System.out.print(pfBrassard[indiceTroisieme[i]]);
            }
            System.out.println(afficherTempsConverti(troisieme, 3));
        }
    }
    ...
    public static String afficherTempsConverti(double pfTemps, int indice){
        ...
        min =0;
            ...
            System.out.println("Cela correspond à un temps de "+min+" minutes et "+secondes+ " secondes.");
            min =0;
        return message;
    }
